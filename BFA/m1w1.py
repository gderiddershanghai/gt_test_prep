...
financial_accounting_extra_question_13 = {
    ...
    'options_list': [
        ...
        'Declaring (but not yet paying) a cash dividend',
        'Paying an accounts payable balance with cash'
    ],
...
financial_accounting_extra_question_35 = {
    ...
    'correct_answer': 'Depreciation expense',
    'explanation': (
        "Depreciation is a non-cash expense. The direct method lists only actual cash inflows and outflows; "
        "non-cash items like depreciation are excluded (though they appear in the reconciliation when companies also present the indirect schedule)."
    ),
    'chapter_information': 'Financial Accounting – extra practice (GPT-generated)'
}
...
financial_accounting_extra_question_46 = {
    ...
    'options_list': [
        ...
        'Collect an overdue accounts receivable',
...
financial_accounting_extra_question_57 = {
    ...
    'options_list': [
        ...
        'Provided services in 2025 but will collect cash in 2026',
        'Incurred expenses in 2025 that will be paid in 2026',
        'Earned revenue in 2025 and collected cash immediately'
    ],
...
BFA_M1W1_MPC = KC_MPC_QUESTIONS[:-1]
